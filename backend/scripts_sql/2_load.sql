...
--
-- Data for Name: informe_sql; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO informe_sql VALUES ('Rol que Cumplen', 'SELECT rolorganizacion AS detalle, id_organizacion FROM (autodiagnosticorolorganizaciones NATURAL JOIN rolorganizaciones)', 'count(*) DESC', 27, NULL, NULL);
INSERT INTO informe_sql VALUES ('Administra Presupuesto', 'SELECT administracionpresupuesto AS detalle, id_organizacion FROM recursosfinancieros', 'count(*) DESC', 28, NULL, NULL);
INSERT INTO informe_sql VALUES ('Area Temática', 'SELECT nombrearea AS detalle,id_organizacion FROM ((organizacion_interna NATURAL JOIN (select id_organizacion, id_areatematica from area_tematica_x_organizacion where prioridad = 1) sub) oixat JOIN area_tematica ON oixat.id_areatematica = area_tematica.id_area)', 'count(*) DESC', 29, NULL, NULL);
INSERT INTO informe_sql VALUES ('Capacitación Interna', 'SELECT implementacapacitacion AS detalle, id_organizacion FROM organizacion_interna', 'count(*) DESC', 30, NULL, NULL);
INSERT INTO informe_sql VALUES ('Demandas Sociales', 'SELECT tipodemanda AS detalle, id_organizacion FROM (organizacion NATURAL JOIN demandas_x_organizacion JOIN demandas_sociales ON demandas_x_organizacion.id_demandasocial = demandas_sociales.id_demanda)', 'count(*) DESC', 31, NULL, NULL);
INSERT INTO informe_sql VALUES ('Documentos Escritos', 'SELECT documentosescritos AS detalle, id_organizacion FROM organizacion_interna', 'count(*) DESC', 33, NULL, NULL);
INSERT INTO informe_sql VALUES ('Identidad de Organización', 'SELECT nombreidentidad AS detalle, id_organizacion FROM (organizacion NATURAL JOIN identidad_x_organizacion NATURAL JOIN identidad)', 'count(*) DESC', 34, NULL, NULL);
INSERT INTO informe_sql VALUES ('Motivo Vinculacion', 'SELECT descripcion AS detalle, id_organizacion FROM (SELECT *, vo.id_organizacionrelevada as id_organizacion FROM vinculacionorgsociales AS vo NATURAL JOIN vinculacionmotivos) sub', 'count(*) DESC', 36, NULL, NULL);
INSERT INTO informe_sql VALUES ('Objetivos Principales Actuales', 'SELECT nombreresumenobjetivos AS detalle, id_organizacion FROM (SELECT idorganizacion as id_organizacion,nombreresumenobjetivos FROM resumenobjorganizacioninterna_x_organizacion) as sub', 'count(*) DESC', 37, NULL, NULL);
INSERT INTO informe_sql VALUES ('Dificultades Autodiagnostico', 'SELECT dificultad AS detalle, id_organizacion FROM (autodiagnosticodificultades NATURAL JOIN dificultades) where prioridad = ''1''', 'count(*) DESC', 32, NULL, NULL);
INSERT INTO informe_sql VALUES ('Modo Accionar', 'SELECT nombremodo AS detalle, id_organizacion FROM (organizacion_interna NATURAL JOIN modo_accionar_x_organizacion NATURAL JOIN modo_accionar) where prioridad = 1', 'count(*) DESC', 35, NULL, NULL);
INSERT INTO informe_sql VALUES ('Organigrama', 'SELECT nombre AS detalle, id_organizacion FROM (forma_de_organizacion NATURAL JOIN organizacion_interna)', 'count(*) DESC', 38, NULL, NULL);
INSERT INTO informe_sql VALUES ('Participan Redes Foro', 'SELECT redesforos AS detalle, id_organizacion FROM vinculacion', 'count(*) DESC', 39, NULL, NULL);
INSERT INTO informe_sql VALUES ('Poblacion Según Edad', 'SELECT perfiledad AS detalle, id_organizacion FROM (organizacion_interna oi JOIN perfiledad_x_organizacion po ON oi.id_organizacion = po.idorganizacion NATURAL JOIN perfiledad)', 'count(*) DESC', 40, NULL, NULL);
INSERT INTO informe_sql VALUES ('Poblacion Según Sexo', 'SELECT poblacionsegunsexo AS detalle, id_organizacion FROM organizacion_interna', 'count(*) DESC', 41, NULL, NULL);
INSERT INTO informe_sql VALUES ('Quienes Demandan', 'SELECT nombrequienes AS detalle, id_organizacion FROM (organizacion NATURAL JOIN quienesefecdem_x_organizacion NATURAL JOIN quienes_efectuan_demandas)', 'count(*) DESC', 42, NULL, NULL);
INSERT INTO informe_sql VALUES ('Rol Deberían Cumplir', 'SELECT rolorganizacion AS detalle, id_organizacion FROM (autodiagnosticoroldeberiancumplir NATURAL JOIN rolorganizaciones)', NULL, 44, NULL, NULL);
INSERT INTO informe_sql VALUES ('Tipo', 'SELECT descripcion AS detalle, id_organizacion FROM (organizacion o JOIN organizaciontipo ot ON o.id_tipoorganizacion = ot.id_tipoorganizacion)', 'detalle', 45, NULL, NULL);
INSERT INTO informe_sql VALUES ('Uso Evaluación', 'SELECT evaluacion AS detalle, id_organizacion FROM organizacion_interna', 'count(*) DESC', 46, NULL, NULL);
INSERT INTO informe_sql VALUES ('Uso Planificación', 'SELECT planificacion AS detalle, id_organizacion FROM organizacion_interna', 'count(*) DESC', 47, NULL, NULL);
INSERT INTO informe_sql VALUES ('Vinculación Estado', 'SELECT vincinstanciasestatales AS detalle, id_organizacion FROM vinculacion', 'count(*) DESC', 48, NULL, NULL);
INSERT INTO informe_sql VALUES ('Figura Legal', 'SELECT figuralegal AS detalle, id_organizacion FROM situacion_juridica', 'count(*) DESC', 49, NULL, NULL);
INSERT INTO informe_sql VALUES ('Visión Política Social', 'SELECT opinion AS detalle, id_organizacion FROM (visionrealidadopinionpoliticasocial NATURAL JOIN opinionpoliticasocial)', 'count(*) DESC', 50, NULL, NULL);
INSERT INTO informe_sql VALUES ('Resumen Situacion Juridica', 'SELECT detalle, id_organizacion FROM (((SELECT id_organizacion, ''SI'' AS detalle
   FROM situacion_juridica
  WHERE upper(situacion_juridica.personeriajuridica) = ''SI''::text
UNION 
 SELECT id_organizacion, ''NO'' AS detalle
   FROM situacion_juridica
  WHERE upper(situacion_juridica.personeriajuridica) = ''NO''::text AND situacion_juridica.usotransitoriocual IS NULL AND situacion_juridica.entramitecual IS NULL)
UNION 
 SELECT id_organizacion, ''USOTRANSITORIO'' AS detalle
   FROM situacion_juridica
  WHERE upper(situacion_juridica.personeriajuridica) = ''NO''::text AND situacion_juridica.usotransitoriocual <> ''''::text)
UNION 
 SELECT id_organizacion, ''ENTRAMITE'' AS detalle 
   FROM situacion_juridica
  WHERE upper(situacion_juridica.personeriajuridica) = ''NO''::text AND situacion_juridica.entramitecual <> ''''::text) sub', 'count(*) DESC', 43, 'TITULO DE SITUACIÓN JURÍDICA', 'RESUMEN QUE SERA');
INSERT INTO informe_sql VALUES ('Alcance Accionar', 'SELECT zonaaccionar AS detalle, id_organizacion FROM organizacion_interna', 'count(*) DESC', 26, 'ASASASA', 'SDFSDFSD');
...
INSERT INTO organizacionrelacionada VALUES (15, 'FEHGRA', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (16, 'Instituto Mixto de Turismo (IMT)', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (17, 'Municipio', 0, 'Estatal', 2);
INSERT INTO organizacionrelacionada VALUES (18, 'A.F.I.P.', 0, 'Estatal', 2);
INSERT INTO organizacionrelacionada VALUES (19, 'Cámaras de Turismo', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (20, 'Rincón Solidario', 241, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (21, 'Facultad de Ciencias Económicas UNCPBA', 0, 'Estatal', 2);
INSERT INTO organizacionrelacionada VALUES (22, 'Geriátricos', 0, 'Otra', NULL);
...
INSERT INTO organizacionrelacionada VALUES (29, 'grupo apicola', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (30, 'INTA', 0, 'Estatal', 2);
INSERT INTO organizacionrelacionada VALUES (34, 'instituto superior de educación fisica', 0, 'Estatal', 2);
INSERT INTO organizacionrelacionada VALUES (38, 'Unión de Rugby de Mar del Plata', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (42, 'U.N.C.P.B.A.', 0, 'Estatal', 2);
INSERT INTO organizacionrelacionada VALUES (44, 'Milicia Mañana', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (46, 'Parroquia Santísimo Sacramento', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (47, 'Caritas Santisimo Sacramento', 64, 'Sociedad Civil Censada', 1);
INSERT INTO organizacionrelacionada VALUES (50, 'Grupo apícola de cambio rural', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (51, 'Eduardo Hall y profesionales del C. de Salud Selvetti', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (52, 'Instituto Superior de Educación física', 0, 'Estatal', 2);
INSERT INTO organizacionrelacionada VALUES (55, 'PAMI', 0, 'Estatal', 2);
...
INSERT INTO organizacionrelacionada VALUES (58, 'Centro de salud', 0, 'Estatal', 2);
...
INSERT INTO organizacionrelacionada VALUES (61, 'Escuelas y jardines', 0, 'Estatal', 2);
INSERT INTO organizacionrelacionada VALUES (63, 'FerroSud', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (64, 'Pastoral Universitaria Nacional CEPAU', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (65, 'Pastoral Universitaria de Mendoza', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (66, 'Pastoral juvenil Diosesana', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (67, 'PECIFA', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (68, 'CGT', 0, 'Sociedad Civil', 4);
INSERT INTO organizacionrelacionada VALUES (70, 'CGT', 0, 'Otra', 4);
INSERT INTO organizacionrelacionada VALUES (72, 'Asociación Criolla Argentina', 0, 'Otra', NULL);
...
INSERT INTO organizacionrelacionada VALUES (77, 'María Auxiliadora', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (78, 'Cruz Roja', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (79, 'Agrupaciones Tradicionalistas', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (80, 'Sociedad Rural Argentina', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (81, 'Centros de Jubilados', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (82, 'Gimnasio "Mi Club"', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (83, 'Federación Argentina de Casin', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (85, 'Asamblea en defensa de las sierras', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (86, 'Memoria por la vida en Democracia', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (87, 'Desarrollo social municipal', 0, 'Estatal', 2);
INSERT INTO organizacionrelacionada VALUES (88, 'Pajaritos de la Calle', 0, NULL, NULL);
INSERT INTO organizacionrelacionada VALUES (89, 'Taller protegido', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (90, 'EEEnº 501, 503, 504', 0, 'Estatal', 2);
INSERT INTO organizacionrelacionada VALUES (91, 'Fundación Pequeños Hogares', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (92, 'ATAD', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (93, 'Manos Abiertas', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (94, 'Bibliotecas', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (95, 'Centros Comunitarios', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (96, 'Asociación Amigos del Carnaval de mi Tandil', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (97, 'colectividad uruguaya', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (98, 'Ninguna', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (99, 'Club Náutico del Fuerte', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (100, 'Club Náutico de Chascomús', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (101, 'Asociación Universitaria Náutica de Mar del Plata', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (102, 'Ministerio de Salud de la Provincia', 0, 'Estatal', 2);
INSERT INTO organizacionrelacionada VALUES (103, 'Dirección Nacional de Migraciones', 0, 'Estatal', 2);
INSERT INTO organizacionrelacionada VALUES (104, 'Policia Federal', 0, 'Estatal', 2);
INSERT INTO organizacionrelacionada VALUES (105, 'Pastoral Migratoria', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (106, 'Club Social y Deportivo Talleres', 220, 'Sociedad Civil Censada', 1);
INSERT INTO organizacionrelacionada VALUES (107, 'club Atlético Banco de la Provincia de Buenos Aires Delegación Zonal Tandil', 24, 'Sociedad Civil Censada', 1);
INSERT INTO organizacionrelacionada VALUES (108, 'Club Huracán', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (109, 'Club San Martín', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (110, 'Ligas de fútbol', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (111, 'Asociación de ajedrez', NULL, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (112, 'Fundación Horacio Zorraquím', 0, 'Otra', NULL);
INSERT INTO organizacionrelacionada VALUES (115, 'clubes', 0, 'Otra', NULL);
...
INSERT INTO organizacionrelacionada VALUES (126, NULL, 0, NULL, 1);
INSERT INTO organizacionrelacionada VALUES (127, NULL, 0, NULL, 1);
INSERT INTO organizacionrelacionada VALUES (128, NULL, 0, NULL, 1);
INSERT INTO organizacionrelacionada VALUES (129, 'Fundación Rotaria a nivel Internacional. Sede: EEUU', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (130, 'Escuela Técnica Nº 2 Felipe Senillosa', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (131, 'Fundación Rotary Internacional', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (132, 'Fundaciones', 0, NULL, 3);
INSERT INTO organizacionrelacionada VALUES (133, 'Fundación', 0, NULL, 3);
INSERT INTO organizacionrelacionada VALUES (134, 'Fundación', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (135, 'Estado provincial', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (136, 'Estado Nacional', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (137, 'Todas las peñas y organizaciones nativistas de la zona', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (138, 'Hospital Municipal Ramón Santa Marina', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (139, 'Salud Mental', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (140, 'Hospital Municipal Ramón Santa Marina', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (141, 'Banco de alimentos', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (142, 'Asociación de cine Tandil', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (143, 'UPCN Secr. de Cultura de la Nación', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (144, 'Conservatorio Isaias Orbe', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (145, 'CIRCULO TRENTINO', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (146, NULL, 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (147, NULL, 0, NULL, 1);
INSERT INTO organizacionrelacionada VALUES (148, 'Biblioteca Martin Fierro', 0, NULL, NULL);
INSERT INTO organizacionrelacionada VALUES (149, 'Sala abierta de lectura', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (150, 'B', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (151, 'Ministerio de Trabajo de Nación', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (152, 'La Bancaria casa central', 0, NULL, 4);
INSERT INTO organizacionrelacionada VALUES (153, 'Confederación general del Trabajo', 0, NULL, 4);
INSERT INTO organizacionrelacionada VALUES (154, 'Hospital Austral', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (155, 'Fundacion Sales', 0, NULL, 3);
INSERT INTO organizacionrelacionada VALUES (156, 'Asociacion de Farmacias Mutuales de la Argentina', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (157, 'Centros Medicos', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (158, 'Hospital Austral', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (159, 'Hospital Austral', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (160, 'UNLP', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (161, 'UFLO', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (162, 'Club River Plate (La Plata)', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (163, 'Paraje Titi', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (164, 'panaderías y fábricas de pastas', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (165, 'ejército', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (166, 'Escuela Nº32', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (167, 'Escuela Nº 32', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (168, 'Ejército', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (169, NULL, 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (170, 'Secretaria de Desarrollo Social', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (171, 'Asociación de Bibliotecas', 0, NULL, 7);
INSERT INTO organizacionrelacionada VALUES (173, 'Obras sociales', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (174, 'Colegio de farmacéuticos', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (175, 'Facultad de Cs. Veterinarias. UNCPBA', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (176, NULL, 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (177, 'C.T.A.', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (178, 'Centro de Salud V. Aguirre', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (180, 'Asociació Civil Casa del Niño en la calle. Granja Los Pibes', 263, NULL, 1);
INSERT INTO organizacionrelacionada VALUES (181, 'Escuelas', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (182, 'Centro de salud Palermo', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (183, 'CEF', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (184, 'CIE', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (185, 'Universidad barrial', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (186, 'Sociedades de Fomento', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (187, 'Ministerio de Desarrollo Social de la Nación', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (188, 'Organizaciones de la Sociedad Civil de todo el país que trabajan con microcréditos', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (189, 'Red Regional de Bancos Populares', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (190, 'Ministerio de Educación de la Provincia', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (191, 'Hospital de Niños Debilio Blanco Villegas', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (192, 'Asilo de Ancianos', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (193, 'Centro Comunitario San Cayetano', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (194, 'Instituto de fornación Docente Nº10 (ISER)', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (195, 'Facultad de Arte (UNICEN)', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (196, 'Rotary Club Tandil', 97, NULL, 1);
INSERT INTO organizacionrelacionada VALUES (197, 'Colegio Santo Domingo de la Sierra', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (198, 'Facultad de Ciencias Humanas (UNICEN)', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (199, 'Instituto de formación Docente Nº 10 (ISER)', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (200, 'Asociación de Bibliotecas Populares', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (201, 'Fundación Leer', 0, NULL, 3);
INSERT INTO organizacionrelacionada VALUES (202, 'CONABIP', 0, NULL, 2);
INSERT INTO organizacionrelacionada VALUES (203, 'CAMPA (Azul)', 0, NULL, 13);
INSERT INTO organizacionrelacionada VALUES (204, 'Hospital Italiano', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (205, 'Hospital Italiano / Clínica Alemana de Chile', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (206, 'Casino', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (207, 'Comisión de Tejedoras Danesas', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (208, 'Rosadas Voluntarias del Hospital Ramón Santamarina', 60, NULL, 1);
INSERT INTO organizacionrelacionada VALUES (209, 'Asociación Argentina de volantes', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (210, 'Asociación Argentina de Volantes', 0, NULL, 5);
INSERT INTO organizacionrelacionada VALUES (211, 'Centro de Salud del barrio', 0, NULL, 2);
...
INSERT INTO organizacionrelacionada VALUES (214, 'asociaciones sobre accidentes de tránsito', 0, NULL, 13);
INSERT INTO organizacionrelacionada VALUES (215, 'Asociaciones de accidentes de transito', 0, NULL, 13);
INSERT INTO organizacionrelacionada VALUES (216, 'ADECUA', 0, NULL, 13);
INSERT INTO organizacionrelacionada VALUES (217, NULL, 0, NULL, 13);
INSERT INTO organizacionrelacionada VALUES (218, NULL, 0, NULL, 2);
...
--
-- Data for Name: problemascarga; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO problemascarga VALUES (2, '2003-05-30 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 5, '1', 'No se puede cargar  supervisor ni zona', 'Sin completar', 'ninguna', 'Completar los campos que faltan', NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (3, '2003-05-30 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 4, '2.2.1', 'No se puede cargar Org. Externa', 'No está el nombre', 'Org. Ext = Sin Especificar', 'Escribir el nombre', NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (4, '2003-06-01 00:00:00', 'Entrevista Particular', 'Texto confuso', 6, '1.2', 'Dirección e-mail confusa', 'una letra no identificada', 'cargada suponiendo una r', 'revisar direccion', NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (5, '2003-06-01 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 6, '2.2.1', 'No se puede cargar Casa Matriz Externa', 'No especifica el nombre', '=Sin Especificar', 'revisar y completar el campo', NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (6, '2003-06-01 00:00:00', 'Entrevista Particular', 'Campos mal completados', 8, '1.2', 'No se pueden cargar todos los entrevistados', 'Se previó que sería uno solo', 'Se cargó el presidente', 'Mantener uno solo en lo posible', NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (7, '2003-06-01 00:00:00', 'Entrevista Particular', 'Códigos inexistentes', 8, '6.7', 'El código de modo de accionar es Otro', NULL, 'Se carga como código 2 porque se interpreta es lo mismo', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (8, '2003-06-01 00:00:00', 'Entrevista Particular', 'Texto confuso', 8, '7.3.2', 'La opción otra se ajusta a una opción existente', NULL, 'Carga de la opción existente = 3', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (10, '2003-06-04 00:00:00', 'Entrevista Particular', 'Campos mal completados', 9, '6,2', 'Hay 2 Alcances que no tienen prioridad', NULL, 'quedan con prioridad 0', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (11, '2003-06-04 00:00:00', 'Entrevista Particular', 'Campos mal completados', 9, '7.1', 'En uno de los campos Origen de la renta hay una B (deberia ser b1 o b2)', NULL, 'Puse b1', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (12, '2003-06-04 00:00:00', 'Entrevista Particular', 'Campos mal completados', 9, '7.2.2', 'El cuadro Origen de la financiacion esta completado con porcentajes', NULL, 'Sin completar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (13, '2003-06-04 00:00:00', NULL, NULL, 10, NULL, NULL, NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (14, '2003-06-04 00:00:00', 'Entrevista Particular', 'Texto confuso', 10, '4.4', 'No se entiende la letra', NULL, 'Falta terminar de completar el texto', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (15, '2003-06-04 00:00:00', 'Entrevista Particular', 'Campos mal completados', 10, '6.6', 'Pone como otra posibilidad "Promoción", dado que existe la opcion nº 5 "Prevención y Promoción"', NULL, 'Puse opción nº 5', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (16, '2003-06-04 00:00:00', 'Entrevista Particular', 'Texto confuso', 10, '6.14.1', 'Palabra confusa', NULL, 'Falta completar este campo', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (17, '2003-06-04 00:00:00', 'Entrevista Particular', 'Texto confuso', 11, '1.2', 'No esta clara la direccion de mail', NULL, 'Sin cargar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (18, '2003-06-04 00:00:00', 'Entrevista Particular', NULL, 11, '2.1.1', 'Casa Matriz', NULL, 'Sin cargar (especificar bien el nombre)', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (21, '2003-06-04 00:00:00', 'Entrevista Particular', 'Campos mal completados', 11, '6.9.3', 'En forma de registro, no hay prioridades, solo X', NULL, 'Las 2 opciones quedaron con prioridad 0', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (22, '2003-06-04 00:00:00', 'Entrevista Particular', 'Campos mal completados', 11, '7.1', 'En el campo Origen de la Renta puso a-b (dos opciones debe ser solo una)', NULL, 'Puse ninguna, hasta definirlo', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (23, '2003-06-04 00:00:00', 'Entrevista Particular', 'Campos mal completados', 11, '7.1.4', ' No se especifico una cantidad, solo X', NULL, 'Sin completar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (24, '2003-06-05 00:00:00', 'Entrevista Particular', 'Campos mal completados', 11, '7.2.2', 'No se determina el origen de la financiacion', NULL, 'Sin completar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (25, '2003-06-05 00:00:00', 'Entrevista Particular', 'Campos mal completados', 11, '7.2.3', 'En "Provenientes del estado", campo mal completado en Cuanta/os', NULL, 'sin completar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (28, '2003-06-05 00:00:00', 'Entrevista Particular', 'Texto confuso', 11, '9.1', 'No se entiende la letra', NULL, 'Compleatdo parcialmente y ??', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (32, '2003-06-05 00:00:00', NULL, NULL, 12, NULL, NULL, NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (33, '2003-06-05 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 13, '2.2.1', ' No especifica el nombre de la casa matriz', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (34, '2003-06-05 00:00:00', 'Entrevista Particular', 'Texto confuso', 13, '4.3', 'No se entiende la letra (apellidos)', NULL, 'Completado con distintas opciones', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (35, '2003-06-05 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 13, '7.1', 'No especifica Origen de la renta', NULL, 'Puse A', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (37, '2003-06-05 00:00:00', 'Entrevista Particular', 'Campos mal completados', 14, '2', 'Hay 3 entrevistados', NULL, 'Se cargó solo 1', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (38, '2003-06-05 00:00:00', 'Entrevista Particular', 'Campos mal completados', 14, '7.3.2', 'Puso 2 formas de tenencia de propiedad, cuando es 1 sola opcion', NULL, 'Puse la primera opcoion', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (42, '2003-06-06 00:00:00', 'Entrevista Particular', 'Campos mal completados', 17, '6.9.3', 'Se pide orden de importancia de 1 a 3 y hay 4 posibilidades', NULL, 'Se cargaron las 4', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (44, '2003-06-07 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 18, '2.2.1', 'No especifica Casa Matriz Externa', NULL, 'Cargado Sin especificar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (45, '2003-06-07 00:00:00', 'Entrevista Particular', 'Campos mal completados', 18, '3.2', 'Fecha último balance no tiene año', NULL, 'cargado Mes de Mayo', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (46, '2003-06-07 00:00:00', 'Entrevista Particular', 'Campos mal completados', 18, '6.12', 'Opción otra no coincide con Modalidad es cuándo? y no como?', NULL, 'No cargada', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (47, '2003-06-09 00:00:00', 'Entrevista Particular', 'Campos mal completados', 1, '7.1', 'Nivel Educativo Secundario, Profesión Abogado', NULL, 'Se cargó Nivel Educativo Universitario', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (48, '2003-06-09 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 1, '7.2.2', 'Especifica Origen, No especifica montos', NULL, 'No se cargó', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (50, '2003-06-09 00:00:00', 'Entrevista Particular', 'Campos mal completados', 1, '7.3.1', 'Otros: Tractores = Vehiculo', NULL, 'Se cargó Vehiculo', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (51, '2003-06-09 00:00:00', 'Entrevista Particular', 'Ajuste a opción existente', 1, '7.2.5', 'Falta de Ganas de colaborar por parte de la Municipalidad', NULL, 'Negación de Recursos', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (52, '2003-06-09 00:00:00', 'Entrevista Particular', 'Texto confuso', 1, '9.1', 'Texto Causa', NULL, 'Cargado parcialmente y ??', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (53, '2003-06-09 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 2, '7.1', 'Especifica otros recursos humanos pero no cantidad ni demas datos', NULL, 'no se cargó', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (54, '2003-06-09 00:00:00', 'Entrevista Particular', 'Campos mal completados', 2, '8.1.1', 'UOM y Club Ferro no son dependencias municipales del estado', NULL, 'no se cargó. Debería cargarse en 8.2', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (55, '2003-06-09 00:00:00', 'Entrevista Particular', 'Campos mal completados', 26, '8.1', 'Mal especificadas las dependencias del Estado', NULL, 'No se cargaron', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (56, '2003-06-09 00:00:00', 'Entrevista Particular', 'Campos mal completados', 26, '11.3.', 'Otra = Todas Sólo debe haber 3 y priorizadas', NULL, 'No cargado', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (57, '2003-06-09 00:00:00', 'Entrevista Particular', 'Campos mal completados', 26, '11.2.1', 'Otra = Todas Sólo debe haber 3 y priorizadas', NULL, 'No cargado', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (58, '2003-06-09 00:00:00', 'Entrevista Particular', 'Texto confuso', 27, '4.5', 'El texto es ilegible', NULL, 'Carga parcial', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (59, '2003-06-09 00:00:00', 'Entrevista Particular', 'Campos mal completados', 28, '8.3', 'La opción es múltiple, fue considerada única', NULL, 'Se cargó: Si, formales', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (60, '2003-06-09 00:00:00', 'Entrevista Particular', 'Códigos inexistentes', 29, '3.1.3', 'Centro Cultural es figura legal?', NULL, 'No se cargó nada', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (61, '2003-06-09 00:00:00', 'Entrevista Particular', 'Texto confuso', 29, '3.2', 'Personería Jurídica (Azul) + Direcc. Pcial ...', NULL, 'Se asume = y se carga como Direcc. Prov. De ...', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (62, '2003-06-10 00:00:00', 'Entrevista Particular', 'Campos mal completados', 30, '7.3.2', 'Opción otra se ajusta a existente', NULL, 'Se cargó opción 3', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (63, '2003-06-10 00:00:00', 'Entrevista Particular', 'Campos mal completados', 30, '8.1.1', 'Las organizaciones no son dependencias del estado', NULL, 'no se cargó', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (64, '2003-06-10 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 31, '6.9.3', 'No existe priorización', NULL, 'Prioridad 0 para todos', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (65, '2003-06-10 00:00:00', 'Entrevista Particular', 'Campos mal completados', 32, '6.8.2', 'Opción otra parece ajustarse a existente', NULL, 'no se cargó', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (66, '2003-06-10 00:00:00', 'Entrevista Particular', 'Campos mal completados', 32, '7.1.4', 'Debe establecer cantidades', NULL, 'No se cargó', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (67, '2003-06-11 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 33, '7.2.4', 'no establece bien los porcentajes', NULL, 'no se cargó', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (68, '2003-06-17 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 52, '2.2.1', 'No especifica Casa Matriz Externa', NULL, 'Sin especificar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (69, '2003-06-17 00:00:00', 'Entrevista Particular', NULL, 54, NULL, NULL, NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (70, '2003-06-18 00:00:00', 'Entrevista Particular', 'Campos mal completados', 56, '8.1.1', 'El  cuadro esta completado, cuando en la pregunta anterior responde "NO", por lo que este campo NO debería estar completo', NULL, 'sin completar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (71, '2003-06-19 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 58, '6.9.1', 'Pregunta sin completar', NULL, 'Sin completar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (72, '2003-06-19 00:00:00', 'Entrevista Particular', 'Texto confuso', 61, '3.1.2', 'Inscripcion Gremial, es una "figura legal"??', NULL, 'Sin completar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (73, '2003-06-19 00:00:00', 'Entrevista Particular', 'Campos mal completados', 61, '7.2.2', 'No se especifica detalladamente el monto del origen de la financiacion', NULL, 'Sin completar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (74, '2003-06-19 00:00:00', 'Entrevista Particular', 'Campos mal completados', 64, '7.2.3', 'En el campo que dice cantidad figura el importe ($700)', NULL, 'Sin completar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (75, '2003-06-19 00:00:00', 'Entrevista Particular', 'Campos mal completados', 64, '8.3', 'En el campo "Acuerdos/convenios con ...", hay 2 opciones marcadas, cuando debería haber una', NULL, 'Complete la 1º opcion', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (76, '2003-06-20 00:00:00', 'Entrevista Particular', 'Campos mal completados', 70, '3.1.3', 'Esta Marcado "Asociacion Civil" y "Sindicato"', NULL, 'Marque Sindicato, ya que en Identidad (preg. 5) figura Sindicato', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (77, '2003-06-20 00:00:00', 'Entrevista Particular', 'Campos mal completados', 71, '8.1.1', 'No se entiende que quiso poner', NULL, 'Sin completar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (78, '2003-06-21 00:00:00', 'Entrevista Particular', 'Campos mal completados', 74, '8.1.1', 'Completa la opcion que dice que NO tiene vinculacion con otras instituciones y luego completa el cuadro (corresponde a los casos Si o A VECES)', NULL, 'Sin completar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (79, '2003-07-06 00:00:00', 'Entrevista Particular', 'Campos mal completados', 99, '7.1.4', 'No establece cantidades', NULL, 'No se cargaron', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (80, '2003-07-09 00:00:00', 'Entrevista Particular', 'Campos mal completados', 102, '6.4.2', 'Hay 2 opciones marcadas, Niños y Tercera Edad, cuando debe ser una sola opcion', NULL, 'Marque "Multiples edades"', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (81, '2003-07-09 00:00:00', 'Entrevista Particular', 'Campos mal completados', 102, '8.3', 'Hay 2 opciones marcadas ("Si, no formales" y "Si, formales")', NULL, 'Marque la primera opcion', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (82, '2003-07-09 00:00:00', 'Entrevista Particular', 'Campos mal completados', 104, '3.1', 'No completa dentro del cuadro, lo hace afuera. No queda claro.', NULL, 'Sin completar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (83, '2003-07-09 00:00:00', 'Entrevista Particular', 'Campos mal completados', 104, '6.4.2', 'Marca 2 opciones cuando debe ser 1.', NULL, 'Marque "Multiples edades"', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (84, '2003-07-09 00:00:00', 'Entrevista Particular', 'Texto confuso', 105, '9.1', 'No se entiende lo que dice en la causa', NULL, 'Texto incompleto', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (85, '2003-07-09 00:00:00', 'Entrevista Particular', 'Texto confuso', 106, '6.4.1', 'No se entiende la letra en la opcion 8 del cuadro', NULL, 'Sin completar', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (86, '2003-07-09 00:00:00', 'Entrevista Particular', 'Texto confuso', 107, '1.1', 'No se entiende cual seria el nombre de la personeria juridica.', NULL, 'Puse el nombre que figura en el primer renglon', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (87, '2003-07-10 00:00:00', 'Entrevista Particular', 'Campos mal completados', 109, '7.1', 'En la tabla de recursos humanos, origen de la renta ingresa 2 ocpiones, al igual que en monto', NULL, 'Puse la 1º opcion en ambos casos', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (88, '2003-07-11 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 119, NULL, 'Falta la fecha de entrevista', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (89, '2003-07-17 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 135, '1', 'Falta zona', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (90, '2003-07-18 00:00:00', 'Entrevista Particular', NULL, 145, NULL, 'no se especifica ni supervisor, ni zona', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (91, '2003-07-18 00:00:00', NULL, NULL, 146, NULL, 'No especifica ni supervisor ni zona', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (92, '2003-07-18 00:00:00', 'Entrevista Particular', 'Texto confuso', 147, '6.11', 'No se entiende la respuesta de "Actores que participan"', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (93, '2003-07-18 00:00:00', 'Entrevista Particular', 'Campos mal completados', 151, '8.3', 'Hay 2 opciones marcadas en Acuerdos/convenios... Y debe ser 1 opcion', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (94, '2003-07-19 00:00:00', 'Entrevista Particular', NULL, 153, '8.3', 'Marca 2 opciones en vez de una ("acuerdos/convenios...")', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (95, '2003-07-19 00:00:00', NULL, NULL, 153, '11.1', 'contesta "NO", por lo que la pregunta 11.2 no debiera estar contestada', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (96, '2003-07-19 00:00:00', NULL, NULL, 154, '1', 'No especifica ni supervisor ni duracion', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (97, '2003-07-19 00:00:00', NULL, NULL, 154, '6.4.2', 'Hay marcadas 2 opciones, debe ser una', NULL, 'Puse "Multiples edades"', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (98, '2003-07-19 00:00:00', NULL, NULL, 157, '6.4.2', 'Hay marcadas 2 opciones', NULL, 'Puse "Multiples edades"', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (99, '2003-07-19 00:00:00', NULL, NULL, 159, '1', 'Falta zona y fecha de realizacion de la entrevista', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (100, '2003-08-10 00:00:00', 'Entrevista Particular', NULL, 167, NULL, 'Es de tipo 1. Falta Casa Matriz', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (101, '2003-08-10 00:00:00', 'Entrevista Particular', 'Campos mal completados', 167, '6.4.2', 'Hay marcadas 2 opciones', NULL, 'Marque Multiples Opciones', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (102, '2003-08-10 00:00:00', 'Entrevista Particular', 'Campos mal completados', 167, '8.3', 'En "Acuerdos..." hay marcadas 2 opciones, cunado debe ser 1.', NULL, 'Marque la 1º.', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (103, '2003-08-10 00:00:00', 'Entrevista Particular', NULL, 168, NULL, 'Es de tipo 1. Falta Casa Matriz', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (104, '2003-08-12 00:00:00', 'Entrevista Particular', NULL, 169, NULL, 'En Identidad dice "Hogar de día", y marque una opcion que ya estaba "Centro de día"', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (105, '2003-08-12 00:00:00', 'Entrevista Particular', NULL, 169, '7.1', 'En los recursos humanos, hay columnas que no contesta y son obligatorias.', NULL, 'Conteste en todos los casos "Origen de la renta = d1"', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (106, '2003-08-12 00:00:00', 'Entrevista Particular', 'Campos mal completados', 173, '6.3', 'Hay 2 opciones marcadas, y debe ser una', NULL, 'Marque "Urbana"', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (107, '2003-08-12 00:00:00', 'Entrevista Particular', 'Campos mal completados', 173, '6.4.2', 'Hay 2 opciones marcadas y debe ser una', NULL, 'Marque "Multiples edades"', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (108, '2003-08-12 00:00:00', NULL, NULL, 175, NULL, 'No tiene fecha de realizacion de la entrevista', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (109, '2003-08-20 00:00:00', 'Entrevista Particular', 'Campos mal completados', 190, '8.3', 'En "Acuerdos/convenios....", se debe elegir 1 opcion, y hay 2 opciones marcadas', NULL, 'Elegí la primera "no formales"', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (110, '2003-08-20 00:00:00', 'Entrevista Particular', 'Campos Incompletos', 192, '6.7', 'Faltan todos los codigo de las tablas', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (111, '2003-08-20 00:00:00', 'Entrevista Particular', 'Campos mal completados', 192, '8.3', 'En "Acuerdos/convenios....", se debe elegir 1 opcion, y hay 2 opciones marcadas', NULL, 'Elegi la primera opcion', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (112, '2003-08-21 00:00:00', 'Entrevista Particular', 'Texto confuso', 194, '6.7', 'No entiendo la letra en el proyecto 2', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (113, '2003-08-21 00:00:00', 'Entrevista Particular', 'Campos mal completados', 194, '7.2.3', 'Esta completado Rec. Autogenerados, cuando son el 100 % del Estado', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (114, '2003-08-21 00:00:00', 'Entrevista Particular', 'Campos mal completados', 195, '8.1.1', 'Esta escrito el cuadro cuando dice que NO tiene vinculación con instancias estatales', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (115, '2003-08-21 00:00:00', 'Entrevista Particular', 'Campos mal completados', 196, NULL, 'En Casa Matriz Externa solo dice "Colegio"', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (116, '2003-08-21 00:00:00', 'Entrevista Particular', 'Campos mal completados', 196, '6.6', 'Hay 3 opciones marcadas como Nº 1', NULL, 'Puse las 3', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (117, '2003-08-21 00:00:00', 'Entrevista Particular', 'Campos mal completados', 196, '8.3', 'Hay 2 opciones marcadas, cuando debe ser 1', NULL, 'Marque la 1º', NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (118, '2003-08-22 00:00:00', 'Entrevista Particular', NULL, 201, NULL, 'Es tipo 2, y no especifica Casa Matriz', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (119, '2003-09-04 00:00:00', 'Entrevista Particular', 'Texto confuso', 210, NULL, 'No se entineden los datos de los entrevistados. (el 2º y 3º)', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (120, '2003-09-07 00:00:00', NULL, NULL, 217, NULL, 'No especifica nombre de casa matriz', NULL, NULL, NULL, NULL, 'Sin informar');
INSERT INTO problemascarga VALUES (121, '2003-10-09 00:00:00', NULL, NULL, 245, NULL, 'FALTAN HOJAS !!!!
Desde la pregunta 8 en adelante', NULL, NULL, NULL, NULL, 'Sin informar');
...
INSERT INTO vinculacionorgsociales VALUES (22, 80, 0, false, NULL);
...
INSERT INTO vinculacionorgsociales VALUES (260, 180, 0, false, NULL);
...
INSERT INTO vinculacionorgsociales VALUES (109, 230, 0, false, NULL);
